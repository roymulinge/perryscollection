...
/* ─── Placeholder data (replace with API calls to your Django backend) ─── */
const PLACEHOLDER_CATEGORIES = [
  { id: 1, name: "Clothing", slug: "clothing", icon: "ti-shirt" },
  { id: 2, name: "Footwear", slug: "footwear", icon: "ti-shoe" },
  { id: 3, name: "Accessories", slug: "accessories", icon: "ti-sunglasses" },
  { id: 4, name: "Bags", slug: "bags", icon: "ti-briefcase" },
  { id: 5, name: "Jewellery", slug: "jewellery", icon: "ti-diamond" },
  { id: 6, name: "New Arrivals", slug: "new-arrivals", icon: "ti-sparkles" },
];

const PLACEHOLDER_PRODUCTS = [
  { id: 1, name: "Premium Leather Tote", slug: "premium-leather-tote", price: "4500.00", category: { name: "Bags" }, image: null },
  { id: 2, name: "Gold Hoop Earrings", slug: "gold-hoop-earrings", price: "1800.00", category: { name: "Jewellery" }, image: null },
  { id: 3, name: "Linen Summer Dress", slug: "linen-summer-dress", price: "3200.00", category: { name: "Clothing" }, image: null },
  { id: 4, name: "Woven Sandals", slug: "woven-sandals", price: "2600.00", category: { name: "Footwear" }, image: null },
  { id: 5, name: "Silk Scarf", slug: "silk-scarf", price: "1500.00", category: { name: "Accessories" }, image: null },
  { id: 6, name: "Beaded Bracelet Set", slug: "beaded-bracelet-set", price: "950.00", category: { name: "Jewellery" }, image: null },
  { id: 7, name: "Wide Leg Trousers", slug: "wide-leg-trousers", price: "2800.00", category: { name: "Clothing" }, image: null },
  { id: 8, name: "Suede Crossbody Bag", slug: "suede-crossbody-bag", price: "3900.00", category: { name: "Bags" }, image: null },
];
      ...
      <div style={{
        ...
        {product.image ? (
          ...
          <div style={{
            ...
            border: "1px solid rgba(196,148,72,0.25)",
        ...
        <div style={{
          ...
          border: "1px solid rgba(196,148,72,0.22)",
          borderRadius: "20px",
          padding: "3px 10px",
          fontSize: "11px",
          color: "#c49448",
      ...
      <style>{`
        * { box-sizing: border-box; }
        ...
        .pc-hero-eyebrow {
          ...
          color: #c49448; letter-spacing: 0.1em;
        ...
        .pc-stat-value {
          ...
          color: #e8c87a; font-family: Georgia, serif;
          display: block;
        }
        ...
        .pc-hero-badge::after {
          ...
          border-radius: 50%;
          border: 1px solid rgba(196,148,72,0.08);
        }
        .pc-hero-monogram {
          font-family: Georgia, serif;
        ...
        .pc-hero-since {
          font-size: 11px; color: #5a3e22; letter-spacing: 0.08em;
        ...
        .pc-section-label {
          ...
          text-transform: uppercase; color: #c49448;
          display: block; margin-bottom: 0.4rem;
        }
        .pc-section-title {
          font-family: Georgia, serif;
          font-size: clamp(1.6rem, 3vw, 2.2rem);
          font-weight: 400; color: #f0dba8; margin: 0;
          line-height: 1.2;
        }
        ...
        .pc-category-card:hover {
          background: rgba(196,148,72,0.07);
          border-color: rgba(196,148,72,0.35);
        ...
        .pc-banner::after {
          ...
          border-radius: 50%;
          border: 1px solid rgba(196,148,72,0.05);
        }
        .pc-banner-content { position: relative; z-index: 1; }
        .pc-banner-eyebrow {
          font-size: 11px; font-weight: 500; letter-spacing: 0.14em;
          color: #c49448; text-transform: uppercase; margin-bottom: 0.75rem;
          display: block;
        }
        .pc-banner-title {
          font-family: Georgia, serif;
          font-size: clamp(1.8rem, 3.5vw, 2.6rem);
          font-weight: 400; color: #f0dba8; margin: 0 0 0.75rem;
          line-height: 1.2;
        }
        ...
        .pc-trust-icon {
          font-size: 22px; color: #c49448; margin-top: 2px; flex-shrink: 0;
        }
        ...
        .pc-footer-social-btn {
          width: 34px; height: 34px;
          border-radius: 8px;
          border: 1px solid rgba(196,148,72,0.2);
          background: transparent;
          display: flex; align-items: center; justify-content: center;
          color: #9a7a4a; font-size: 16px;
          text-decoration: none;
      ...
      <main style={{ background: "#120a06", minHeight: "100vh" }}>
        ...
        <section className="pc-hero" aria-label="Hero">
          <div className="pc-hero-content">
            <div
              className={`pc-fade-in ${heroVisible ? "visible" : ""}`}
            ...
            >
              ...
              <div className="pc-hero-actions">
                ...
                <Link to="/categories" className="pc-btn-secondary">
                  Browse Categories
                </Link>
              </div>
              <div className="pc-hero-stats">
                <div>
                  <span className="pc-stat-value">500+</span>
                  <span className="pc-stat-label">Products</span>
                </div>
                <div>
                  <span className="pc-stat-value">2k+</span>
                  <span className="pc-stat-label">Happy customers</span>
                </div>
                <div>
                  <span className="pc-stat-value">NBO</span>
                  <span className="pc-stat-label">Nairobi based</span>
                </div>
              </div>
            </div>

            <div
              className={`pc-hero-visual pc-fade-in ${heroVisible ? "visible" : ""}`}
        ...
        {/* ── CATEGORIES ── */}
        <section style={{ padding: "4.5rem 0 0" }} aria-label="Categories">
          ...
          <div className="pc-section">
            <div className="pc-banner">
              <div className="pc-banner-content">
                ...
                <p className="pc-banner-desc">
                  Shop your favourites and get them delivered same day within Nairobi CBD and select estates.
                </p>
              </div>
          ...
          <div className="pc-footer-inner">
            <div className="pc-footer-grid">
              <div className="pc-footer-brand">
                <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                  <div style={{
                    ...
                    background: "linear-gradient(135deg, #c49448 0%, #8b5e1a 100%)",
                    display: "flex", alignItems: "center", justifyContent: "center",
                    fontSize: "14px", fontWeight: "700", color: "#120a06",
                    fontFamily: "Georgia, serif",
                  }}>P</div>
                  <span style={{ fontSize: "15px", fontWeight: "600", color: "#e8c87a", fontFamily: "Georgia, serif" }}>
                    Perry's Collection
                  </span>
                </div>
                ...
                <div className="pc-footer-socials">
                  {["ti-brand-instagram", "ti-brand-tiktok", "ti-brand-whatsapp", "ti-brand-facebook"].map((icon) => (
                    <a key={icon} href="#" className="pc-footer-social-btn" aria-label={icon.replace("ti-brand-", "")}>
              ...
              <div className="pc-footer-col">
                <h4>Shop</h4>
                <ul>
                  {["New Arrivals", "Clothing", "Footwear", "Bags", "Accessories", "Jewellery"].map((item) => (
              ...
              <div className="pc-footer-col">
                <h4>Contact</h4>
                <ul>
                  <li><a href="#"><i className="ti ti-map-pin" style={{ marginRight: 6 }} aria-hidden="true" />Nairobi, Kenya</a></li>
                  <li><a href="#"><i className="ti ti-brand-whatsapp" style={{ marginRight: 6 }} aria-hidden="true" />WhatsApp us</a></li>
                  <li><a href="#"><i className="ti ti-mail" style={{ marginRight: 6 }} aria-hidden="true" />Email us</a></li>
                  <li><a href="#"><i className="ti ti-clock" style={{ marginRight: 6 }} aria-hidden="true" />Mon–Sat, 8am–7pm</a></li>
                </ul>
              </div>
            </div>
            ...
            <div className="pc-footer-bottom">
              ...
              <nav className="pc-footer-legal" aria-label="Legal links">
